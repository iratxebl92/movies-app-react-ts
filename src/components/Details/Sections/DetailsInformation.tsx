...
export const DetailsInformation = ({ data, type }: DetailsInformationProps) => {
 ...
 const allKeywords = [
  ...
  const providers =  [
    ...
    { provider_name: "Max", logo_path: "/aS2zvJWn9mwiCOeaaCkIh4wleZS.jpg", icon: <SiHbo className="text-purple-500" size={20} /> },
    { provider_name: "Apple TV+", logo_path: "/6uhKBfmtzFqOcLousHwZuzcrScK.jpg", icon: <TbBrandApple className="text-gray-100" size={20} /> },
    { provider_name: "Amazon Video", logo_path: "/5NyLm42TmCqCMOZFvH4fcoSNKEW.jpg", icon: <SiAmazon className="text-blue-400" size={20} /> },
    { provider_name: "Disney Plus", logo_path: "/6WzXs9WwbKXyYQY0Y8YZkRJ4Y8YZkRJ4.jpg", icon: <TbBrandDisney className="text-blue-500" size={20} /> },
    { provider_name: "Movistar Plus+ Ficción Total ", logo_path: '/6WzXs9WwbKXyYQY0Y8YZkRJ4Y8YZkRJ4.jpg', icon: <TbMovie className="text-blue-300" size={20} /> }
  ]
