...
export default function OptionsSelect({ options, style = {}, value, onOptionChange, optionKey }: { options: any[], style: any, value: any, onOptionChange: any, optionKey: string }) {
  ...
  return (
    <form style={style}>
      <select
        ...
        value={value}
        onChange={(e) => onOptionChange(e.target.value, optionKey)}
      >
        {options.map((option) => (
