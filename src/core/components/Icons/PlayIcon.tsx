...
export const PlayIcon = ({fill = 'black', stroke = 'black'}: {fill: string, stroke: string}) => {
    return (
  ...
  //group hace que se puedan aplicar los estilos como aplicamos despues group-hover