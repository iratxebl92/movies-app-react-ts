...
export const getDetails = (content: string, id: number, language:string) => `/movie/823?language=es-ES`;
export const getCast = (content: string, id: number) => `/movie/823/credits`;
