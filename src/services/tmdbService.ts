...
export const getDetails = (content: string, id: number, language:string) => `/movie/671?language=es-ES`;
export const getCast = (content: string, id: number) => `/movie/671/credits`;
